...
// Permitir o uso de dados fictícios
// dentro desse teste e que não sejam
// de outra fonte
jest.mock("../models/usuarioModel");

// Estrutura do teste da controller
describe("usuarioController", () => {
  // Definindo a requisição e resposta
  // como variáveis
  let req, res;

  // Definir formatos de dados esperados
